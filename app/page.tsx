...
function HomePage() {
    ...
    return (
        <div className="relative flex h-screen flex-col items-center justify-center p-1 text-center">
            <div className="absolute right-5 top-5 flex items-center gap-2 text-sm font-light sm:text-xl">
            ...
            <p
                className={clsx(
                    `${flavor}`,
                    "text-center text-[50px] text-fern_green sm:text-[100px]",
                )}
            >
                Dejah & Marcus
            </p>
            <div className="flex flex-col items-center justify-center gap-2">
                ...
                >
                    <div className="text-xl font-light underline sm:text-2xl">
